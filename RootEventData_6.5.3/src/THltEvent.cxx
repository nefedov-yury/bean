...
TObject *THltEvent::s_staticHltInf = 0;
TObject *THltEvent::s_staticDstHltInf = 0;
...
THltEvent::THltEvent() 
{
  ...
  if (! s_staticHltInf ) {
    s_staticHltInf = new TObject();
  }
  if (! s_staticDstHltInf ) {
    s_staticDstHltInf = new TObject();
  }
...
//*****************************************************************
void THltEvent::initialize(Bool_t fromMc){ 
    m_fromMc = fromMc;
}
