...
public:
    ...
    inline void setEtsT1(unsigned long value) { m_etsT1 = value; }
    inline void setEtsT2(unsigned long value) { m_etsT2 = value; }

    inline ULong_t getEtsT1() { return m_etsT1; }
    inline ULong_t getEtsT2() { return m_etsT2; }
