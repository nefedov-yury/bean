...
public:
  ...
  //Get rec
  Double_t vx0( void )    const { return m_vx0;    }
  Double_t vy0( void )    const { return m_vy0;    }
  Double_t vz0( void )    const { return m_vz0;    }
  Double_t fiTerm( void ) const { return m_fiTerm; }
