...
class ParticleID : public ParticleIDBase{
 ...
 public:
  ...
  inline bool IsMrpcInfoValid() const;
  //                 get subsys Chi 
  ...
  inline double chiMrpc(int n) const;
  ...
  inline double probMrpc(int n)  const;
...
//  void setCutEm_mu(double cut1, double cut2) {m_cut_em_mu[0]=cut1; m_cut_em_mu[1]=cut2;}
 ...
 private:
  ...
  bool IsMrpcInfoUsed() const {return ((m_pidsys & useMrpc()) == useMrpc());}
