...
//--------------------------------------------------------------------
{
   return ((status & Raw_Mask) >> Raw_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Readout_Mask) >> Readout_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Counter_Mask) >> Counter_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Cluster_Mask) >> Cluster_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Barrel_Mask) >> Barrel_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & East_Mask) >> East_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Overflow_Mask) >> Overflow_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & Multihit_Mask) >> Multihit_Index );
}
...
//--------------------------------------------------------------------
{
   return ((status & MRPC_Mask) >> MRPC_Index );
}
...
{
   m_status   = status;
   m_raw      = ((m_status & Raw_Mask) >> Raw_Index );
   m_readout  = ((m_status & Readout_Mask) >> Readout_Index );
   m_counter  = ((m_status & Counter_Mask) >> Counter_Index );
   m_cluster  = ((m_status & Cluster_Mask) >> Cluster_Index );
   m_barrel   = ((m_status & Barrel_Mask) >> Barrel_Index );
   m_east     = ((m_status & East_Mask) >> East_Index );
   m_layer    = (m_status  & Layer_Mask) >> Layer_Index;
   m_overflow = ((m_status & Overflow_Mask) >> Overflow_Index );
   m_multihit = ((m_status & Multihit_Mask) >> Multihit_Index );
   m_ncounter = (m_status >> Ncounter_Index ) & N_Mask;
   m_neast    = (m_status >> Neast_Index ) & N_Mask;
   m_nwest    = (m_status >> Nwest_Index ) & N_Mask;
   m_mrpc     = ((m_status & MRPC_Mask) >> MRPC_Index );
}
