...
public:
   ...
   void SetTof1ErrorMatrix(const  Double_t Tof1ErrorMatrix[6][6]) {
	       for (Int_t i = 0 ;i<6 ;i++ )
			   for (Int_t j = 0 ;j<6 ;j++ )
	                 myTof1ErrorMatrix[i][j] = Tof1ErrorMatrix[i][j] ; }
   ...
   void SetTof2ErrorMatrix(const  Double_t Tof2ErrorMatrix[6][6]) {
	       for (Int_t i = 0 ;i<6 ;i++ )
			   for (Int_t j = 0 ;j<6 ;j++ )
	                 myTof2ErrorMatrix[i][j] = Tof2ErrorMatrix[i][j] ; }
   ...
   void SetEmcErrorMatrix(const  Double_t EmcErrorMatrix[6][6]) {
	       for (Int_t i = 0 ;i<6 ;i++ )
			   for (Int_t j = 0 ;j<6 ;j++ )
	                 myEmcErrorMatrix[i][j] = EmcErrorMatrix[i][j] ; }
   ...
   void SetMucErrorMatrix(const  Double_t MucErrorMatrix[6][6]) {
	       for (Int_t i = 0 ;i<6 ;i++ )
			   for (Int_t j = 0 ;j<6 ;j++ )
	                 myMucErrorMatrix[i][j] = MucErrorMatrix[i][j] ; }
  ...
  Double_t    GetTof1MomentumZ()      const   { return  myTof1MomentumZ ;    }
   ...
   Double_t  GetTof1ErrorMatrix(Int_t i , Int_t j) const {return myTof1ErrorMatrix[i][j]; }
  ...
  Double_t    GetTof2MomentumZ()      const   { return  myTof2MomentumZ ;    }
   ...
   Double_t  GetTof2ErrorMatrix(Int_t i , Int_t j) const {return myTof2ErrorMatrix[i][j]; }
  ...
  Double_t    GetEmcMomentumZ()      const   { return  myEmcMomentumZ ;    }
   ...
   Double_t  GetEmcErrorMatrix(Int_t i , Int_t j) const {return myEmcErrorMatrix[i][j]; }
  ...
  Double_t    GetMucMomentumZ()      const   { return  myMucMomentumZ ;    }
   ...
   Double_t  GetMucErrorMatrix(Int_t i , Int_t j) const {return myMucErrorMatrix[i][j]; }
...
private:
	...
	Double_t myTof1ErrorMatrix[6][6]; //Error matrix 6x6 (x,p)
	...
	Double_t myTof2ErrorMatrix[6][6]; //Error matrix 6x6 (x,p)
	...
	Double_t myEmcErrorMatrix[6][6]; //Error matrix 6x6 (x,p)
